...
| 层级 | 最后核验 | 结论 |
|---|---|---|
| 客户端源码与 CI | `8033161bb837398c272bfa6585c01a426049854c` / run `29649570146` | 当前工作分支的 Xcode 26.3 编译、SwiftLint、服务端检查与仓库安全检查通过；不代替真机体验验收 |
| 最近 iOS 产物 | `8033161bb837398c272bfa6585c01a426049854c` / run `29649576223` | Xcode 26.3 unsigned IPA 归档和下载校验通过，版本 `0.2.0 (13)` |
...
- 大橘日记按作息日从共同聊天生成：服务端先从日总览挑一条主线，再围绕话题时间点补取少量共同聊天原文来写，避免把全天事项逐项复述；大橘主页展示最新一篇，日记书架浏览历史，详情页可确认后按原聊天重新整理当日内容。正文保留自然段落，模型不可用时使用聚焦且事实受限的本地叙事兜底。

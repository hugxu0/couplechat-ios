...
| 3 | R3.1 媒体 Viewer 协调器 | 进行中 | R2.3 |
| 3 | R3.2 交互式下拉退出 | 进行中 | R3.1 |
| 3 | R3.3 统一其他媒体入口 | 进行中 | R3.2 |
| 4 | R4.1 纯时间线构建器 | 进行中 | R3.3 |
| 4 | R4.2 滚动策略状态机 | 进行中 | R4.1 |
| 4 | R4.3 消息动作提供器 | 进行中 | R4.2 |
| 4 | R4.4 ChatTimelineController | 进行中 | R4.3 |

...
3. [V2 产品计划](V2_PRODUCT_PLAN.md)：查看已确认的产品边界、五个主入口和功能验收。
4. [V2 技术架构](V2_ARCHITECTURE.md)：查看多情侣、多设备、Sync V2、媒体和 Bark 迁移路线。
5. [客户端体验与整体架构优化计划](REFACTOR_PLAN.md)：历史重构的顺序、边界和验收标准。
6. [系统架构](ARCHITECTURE.md)：理解当前客户端、服务端、数据库和实时链路。
7. [开发指南](DEVELOPMENT.md)：建立本地调试和验证流程。
8. 按任务阅读 [接口契约](API.md)、[AI 系统](AI.md) 或 [生产部署](DEPLOYMENT.md)。
9. [R0-R8 完成报告](RELEASE_REPORT_2026-07-12.md)：查看上一轮改造、部署结果和当时的残余风险。
...
| `V2_PRODUCT_PLAN.md` | 已确认的 V2 信息架构、功能设计和验收 | 产品范围、优先级或交互决策变化 |
| `V2_ARCHITECTURE.md` | 多情侣/多设备架构、迁移、同步和通知 | V2 核心数据模型或发布顺序变化 |
...
| `RELEASE_REPORT_2026-07-12.md` | R0-R8 改造、测试、发布与清理的历史报告 | 只追加勘误，不用它表达 V2 当前状态 |
